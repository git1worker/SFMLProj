...
int main() {
    ...
    // sf::RenderWindow window = sf::RenderWindow(sf::VideoMode(500, 500),
    // "test"); sf::Texture tmp;
    ...
    // player.setPosition(sf::Vector2f(window.getSize().x/2,
    // window.getSize().y/2)); player.setTextureRect(t);
    ...
    // sf::Sprite a(tmp2);
    // a.setPosition(sf::Vector2f(window.getSize().x/3 + offsetRelativeCenter.x,
    // window.getSize().y/3 + offsetRelativeCenter.y)); a.setTextureRect(t);
    ...
    //     a.setPosition(sf::Vector2f(a.getPosition().x, a.getPosition().y +
    //     pxPerFrame)); f.left = a.getPosition().x; f.top = a.getPosition().y;
