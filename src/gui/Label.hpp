...
class Label : public Element {
  public:
    ...
    enum Anims { None, AppearanceDecay };
    Label() = default;
    Label(sf::RenderWindow *window, sf::Font *font, std::wstring text, const float x, const float y, Align align = Align::Center,
          const unsigned int fSize = 30, const float w = 200);
