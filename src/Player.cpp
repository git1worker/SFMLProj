...
void Player::Update() {
    if (!death){
        Timer t;
        if (gamew->leftMouseButtonPrerssed){
        ...
        // std::cout << t.GetTime() << std::endl; // 2276us 89us 3623us 2021us 94us 2204us
        blood.Update();
        //std::cout << t.GetTime() << std::endl; // 102us 74us 99us 3460us 3704us
        UpdateRotation();
        // std::cout << t.GetTime() << std::endl; // 340us 522us 1981us 1832us
        ...
        // std::cout << t.GetTime() << std::endl;//518us 2868us 2676us 2789us
    }
